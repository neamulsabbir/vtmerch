export const Testimonial = () => {
	return (
		<section className="bg-gradient-to-r from-[#EC3339] to-[#BB1117] relative px-[50px] lg:px-[150px]">
			<div className="flex justify-between items-center flex-wrap gap-6 md:gap-10 xl:gap-0">
				<div className="flex-grow lg:max-w-screen-md xl:max-w-[860px] lg:pt-20 lg:pb-10 xl:py-40 px-6 md:px-0">
					...
					<p className="text-xl md:text-3xl lg:text-4xl font-bold  pt-10 md:pt-16 lg:pt-2 font-montserrat text-white leading-[350px]">
						OUR MISSION IS TO ENLIGHTEN, ENTERTAIN AND EMPOWER CURRENT AND FUTURE LEADERS AROUND THE WORLD.
					</p>
				</div>

				<div className="static mx-auto xl:absolute bottom-0 right-[5%] overflow-hidden sm:overflow-visible">
					<img
